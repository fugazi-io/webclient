...
export namespace builder {
	...
	export function create(url: net.Url): componentsBuilder.Builder<Module>;
	export function create(moduleDescriptor: descriptor.Descriptor, parent?: componentsBuilder.Builder<components.Component>): componentsBuilder.Builder<Module>;
	export function create(moduleDescriptor: net.Url | descriptor.Descriptor, parent?):componentsBuilder.Builder<Module> {
	...
	export class Builder extends componentsBuilder.BaseBuilder<Module, descriptor.Descriptor> {
		private innerModuleBuilders: collections.Map<componentsBuilder.Builder<Module>>;
		...
		protected onDescriptorReady(): void {
			...
			this.innerModuleBuilders = collections.map<componentsBuilder.Builder<Module>>();
